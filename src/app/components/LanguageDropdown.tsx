...
const LanguageDropdown = () => {
  ...
  return (
      <div className="relative inline-block text-left" ref={ref}>
        ...
        {isOpen && (
            <ul
                className="absolute z-10 translate-x-2 mt-1 w-fit rounded-md shadow-sm bg-background dark:bg-background-dark overflow-hidden"
            >
              {languages.map(({ code, flag }) => (
                  ...
                  >
                    <div className="flex items-center justify-center"> {/* Center content within the list item */}
                      <Image
                          width={22}
                          height={22}
                          src={flag}
